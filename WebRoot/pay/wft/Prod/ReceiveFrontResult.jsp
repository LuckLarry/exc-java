 ...
 * 功能说明
 * <ul>
 * <li>	创建文件描述：生产环境,V34前端交易结果返回调试页面入口</li>
 * <li>	主要功能：商户录入订单数据加密信息、时间戳签名,提交表单到逻辑处理页面ReceiveFrontResultProcess.jsp</li>
 * <li>	访问链接:http://localhost:8080/Gnetpg_Pay_Gateway_By_V34_Vendor_Java_UTF-8/Prod/ReceiveFrontResult.jsp</li>
 * <li></li>
 * </ul>
 * 
 * @author <ul>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>广州银联网络-前端交易结果返回示例V3.4</title>
	<link rel="stylesheet" type="text/css" href="../Themes/Style/Gnetpg.css" />
</head>
<body>

<form method="post" name="OrderForm" action="ReceiveFrontResultProcess.jsp">
	<div class = "BoxBody">
		<div class = "PayHead" >
			<div class = "HeadTitle">商户联调生产环境-前端交易结果返回示例V3.4</div>
		</div>
