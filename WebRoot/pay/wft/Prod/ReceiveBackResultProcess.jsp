 ...
 * 功能说明
 * <ul>
 * <li>	创建文件描述：生产环境,V34后台异步通知交易结果返回逻辑处理页面</li>
 * <li>	主要功能：</li>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>广州银联网络-后台异步通知交易结果返回逻辑处理页面</title>
...
<%
	/**
	  ...
	  */
	  ...
	  /*******************2.对信息进行解密并校验时间戳签名*********************/
	  //接受方证书路径(银联证书-公钥)
	  String RcvCertPath =WftXml.getGNETE(ItemHelper.getContextPath());// ContextPath+"Prod\\Resource\\GNETE.cer";
	  //发送方证书路径(商户证书-私钥)
	  String SendCertPath =WftXml.getDnz_LouLan(ItemHelper.getContextPath());// ContextPath+"Prod\\Resource\\JIAXI.pfx";
	  //发送方证书密码
	  String SendCertPWD =WftXml.SendCertPWD;// "12345678"; 
      ...
      //如果在成功接收并处理交易结果后，一定要响应"OK"，否则我们就会一直推送，对商户的服务器压力也会影响
