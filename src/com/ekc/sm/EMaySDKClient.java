...
public class EMaySDKClient {
	...
	//public static String password="501683";// 密码,请通过亿美销售人员获取
	//public static String password="449721";// 密码,请通过亿美销售人员获取
	
	public static String sn = "2SDK-EMY-xxx-xxx";// 软件序列号,请通过亿美销售人员获取
    public static String key = "xxx";// 序列号首次激活时自己设定
	 ...
	 */
	public static int registEx() throws Exception {
	...
	public static int sendSMS(String[] phone, String msg) throws Exception {
		int i=SingletonClient.getClient().sendSMS(phone, msg, 5);
		return i;
	}
	/**
	 * 发送短信、可以发送定时和即时短信
	 ...
	 * 5、其它短信发送请参考使用手册自己尝试使用
	 */
	public static int sendSMS(String[] phone, String msg,String type) throws Exception {
		SingletonClient.setClientType(type);
		return SingletonClient.getClient().sendSMS(phone, msg, 5);
	}
