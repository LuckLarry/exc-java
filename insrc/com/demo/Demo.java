...
public class Demo {
	...
	private static String appid = "wx29581c5f8e0336ff";
	private static String appsecret = "D:/pbdown/exc/WebRoot/WEB-INF/cert/wx/apiclient_cert.p12";
	private static String partner = "";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "Jo8hJTwEO0R2gAvH3l5UYYOWAKMbNQrg";
	//openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "1232563802";
	//微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "gfgf";																	 // Key
